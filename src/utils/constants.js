// Scrolling words from your current site
...
export const faqs = [
  {
    ...
    answer:
      "Our high-intensity training is specifically designed for stroke and SCI recovery, utilizing evidence-based techniques that produce remarkable results in just 3-5 days. Our methods focus on neuroplasticity and intensive practice to help survivors regain function and independence.",
  },
  {
    question: "How many days is a typical bootcamp?",
    answer:
      "Our bootcamps typically run 3-5 days with intensive, personalized training sessions. Each day builds upon the previous, creating momentum and measurable progress throughout the program.",
  },
  {
    question: "What kind of support is provided AFTER a RISE bootcamp?",
    answer:
      "We provide comprehensive follow-up support including personalized exercise programs, ongoing consultation, and access to our network of certified professionals to ensure continued progress after your bootcamp experience.",
  },
  {
    question: "Do you accept insurance?",
    answer:
      "We work with various insurance providers and can help you understand your coverage options. Our team will assist you in determining what may be covered and explore all available options for making RISE accessible to you.",
  },
];
